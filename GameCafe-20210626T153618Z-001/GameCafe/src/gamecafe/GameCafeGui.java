 ...
 * @author Michael
 */
public class GameCafeGui extends javax.swing.JFrame {

    /**
     * Creates new form GameCafeGui
     */
    public GameCafeGui() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Vanrick Game Cafe");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GameCafeGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GameCafeGui().setVisible(true);
            }
        });
    }
